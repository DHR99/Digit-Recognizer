...
As we have plenty of 0 in some of the columns, this will make the variance to be close to 0 which is not good for our model. We will find those predictors and we will drop them from the dataset
```{r}
